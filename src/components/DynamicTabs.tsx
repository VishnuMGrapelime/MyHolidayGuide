...
const DynamicTabs = ({ tabs, setTabs, lang, d }: { tabs: any, setTabs: any, lang: any, d: any }) => {
  ...
  return (
    <div className=''>
      <button
        className='py-2.5  px-5 me-2 text-center align-content  mb-2 text-sm w-full font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-[#1CCFB9] hover:bg-gray-100  focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700'
        onClick={addTab}
      >
        <svg
