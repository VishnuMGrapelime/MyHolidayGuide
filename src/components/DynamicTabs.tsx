            ...
            {tabs.map((tab) => (
              <li key={tab.id} className='me-2'>
                ...
                >
                  {tab.title}
                  &nbsp;
                  <svg onClick={() => deleteTab(tab.id)} className="w-[19px] h-[19px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
