  ...
  return (
    <div>
      <div className='m-12 p-12'>
        ...
        <h2 className="pb-6 md:pb-3 text-h2 md:text-h1 font-bold"><span>Company information</span></h2>
        </div>
      </div>
      {initialValues && (
        // <Formik
        ...
        <div className="grid items-end w-full mx-auto gap-6 mb-6 md:grid-cols-1">
          ...
          <div className='space-y-1'>
            ...
            <p className="text- md:text- px-4 ">
              <span>Please enter the street address of your company headquarters</span></p>
          </div>
          <div className='space-y-1'>
            <div className="relative ">
              <input
          ...
          <div className='space-y-1'>
            ...
            <p className="text- md:text- px-4 ">
              <span>(optional) Please enter your post office box number of your organisation </span></p>
          </div>
          <div className='space-y-1'>
            <div className="relative ">
              <input
            ...
            <p className="text- md:text- px-4 ">
              <span>Please enter the zip code of your company headquarters </span></p>
          </div>
          <div className='space-y-1'>
            <div className="relative ">
              <input
            ...
            <p className="text- md:text- px-4 ">
              <span>Please enter the city of your company headquarters </span></p>
          </div>
          <div className='space-y-1'>
            <div className="relative ">
              <input
