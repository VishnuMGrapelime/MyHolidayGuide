...
export default function Stepper({ currPage, lang }: { currPage: any, lang: string }) {
  ...
  return (
    <>
      <div className='mb-12'>
        <ul className="flex  justify-center text-center stepIcon md:whitespace-nowrap">
          <li className="flex w-full ml-16 md:ml-44 items-center text-black dark:text-blue-500 after:content-[''] after:mx-1 after:w-full after:h-1 after:border-b after:border-[#1CCFB9] after:border-1 after:inline-block dark:after:border-blue-800 ">
