...
export const ButtonOutline = ({ label, prevStep }) =>
{
  return (
    ...
    shadow-md dark:bg-[#0f1b38] dark:text-neutral-50 dark:hover:text-neutral-50 dark:hover:bg-green-200 dark:hover:bg-opacity-10 
    w-full sm:w-auto sm:min-w-[270px]" onClick={prevStep} ><span>{label}</span></button>
  );
}

export const LinkButton = ({ label, link }) =>
{
  return (
    <>
      <Link href={link}>
